...
func (a AutomationGetIdentityProviderGlobals) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AutomationGetIdentityProviderGlobals) UnmarshalJSON(data []byte) error {
...
func (a AutomationGetIdentityProviderRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(a, "", false)
}

func (a *AutomationGetIdentityProviderRequest) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &a, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (a *AutomationGetIdentityProviderRequest) GetIdentityKey() string {
	if a == nil {
		return ""
	}
